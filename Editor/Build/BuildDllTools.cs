...
public class BuildDllTools
{
    ...
    private static string DLLPATH = "/Hotfix/" + LWUtility.HotfixFileName;
    /// <summary>
    /// 编译DLL
    /// </summary>
...
#region CS DLL引用搜集处理
    ...
    static public void Build(
        ...
        bool isdebug=false)
    {
        var baseDll = outHotfixDllPath.Replace(LWUtility.HotfixFileName, "Assembly-CSharp.dll");
        //开始执行
    ...
    /// </summary>
    /// <returns></returns>
    public static List<string> FindDLLByCSPROJ(string projName,ref List<string> dllList)
    {
